...
def run():
    ...
    # evaluate() must return y_true, y_pred, y_score as in the version I sent
    ...
    # -------- NEW: use values from results dict --------
    ...
    plot_confusion(
        ...
        title="Breast Cancer – Class Weights",
        filename="bc_confusion_weights.png",
    )
    ...
    plot_roc_pr(
        y_true=y_true,
        y_score=y_score,
        title_prefix="Breast Cancer – Class Weights",
        filename="bc_roc_pr_weights.png",
    )
